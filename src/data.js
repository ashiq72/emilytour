...
import ashik from "./assets/lelouch.jpg";
...
const Japan = {
  title: "Japan",
  description:
    "Discover the ancient traditions, vibrant culture, and stunning natural beauty of Japan - a truly unforgettable travel experience.",
  image: jimg,
};
const France = {
  title: "France",
  description:
    "Indulge in the art, cuisine, history, and romance of France - a dream destination for travelers seeking charm and sophistication.",
  image: fimg,
};
const Korea = {
  title: "Korea",
  description:
    "Experience the dynamic blend of modern innovation and rich cultural heritage in Korea - a land of beauty, tradition, and adventure",
  image: kimg,
};
...
const tst1 = {
  description:
    "Emily provided very good tour guide service. Thank you so much Emily. I will look for you if I need a guide again",
  name: "-Denma,",
  status: "ashiq Ahmed",
  image: ashik,
};
const tst2 = {
  description:
    "Highly impressed with the website's authentic cultural representation.",
  name: "-Lelouch,",
  status: "Zeon",
  image: lelouch,
};
...
const fk1 = {
  description:
    "Discover the legend of Susanoo, the powerful Shinto god of storms and the sea. Banished from heaven for his unruly behavior, Susanoo descended to earth and encountered a fierce dragon,Yamata-no-Orochi. With the help of a clever plan and his own strength, Susanoo battled the dragon to save avillage and earn his place among the gods.",
  name: "Susanoo",
  image: fk1img,
};
const fk2 = {
  description:
    "Join Izanagi, the powerful god of creation in Japanese mythology, on his perilous journey to Yomi, the land of the dead. Discover how he sought to rescue his beloved wife Izanami and the terrible consequences that ensued. Explore this haunting tale of love, loss, and the boundaries between life and death.",
...
const Cs1 = {
  description:
    "Sushi is a traditional Japanese dish that consists of vinegared rice combined with a variety of toppings, such as seafood, vegetables, and egg. It is served with soy sauce, wasabi, and pickled ginger, and has become a popular cuisine worldwide due to its history, artistry, and unique flavors.",
  name: "Sushi",
  image: Sushiimg,
};
const Cs2 = {
...
const Cl1 = {
  description:
    "Sadō, also known as the Japanese tea ceremony, is a traditional cultural activity that involves the ceremonial preparation and presentation of powdered green tea. It has deep roots in Japanese history and is often seen as a symbol of Japanese culture, emphasizing the principles of harmony, respect, purity, and tranquility.",
  name: "Sadō",
  image: Sadoimg,
};
const Cl2 = {
  description:
    "Hanami is a Japanese tradition of enjoying the beauty of cherry blossom trees. People often have picnics and parties under the blooming trees during the spring season. It is a symbol of the transience of life and is deeply ingrained in Japanese culture, representing renewal and new beginnings.",
  name: "Hanami",
  image: Hanamiimg,
};
const Cl3 = {
  description:
    "Ikebana is the Japanese art of flower arrangement, which emphasizes simplicity, asymmetry, and the use of natural materials. It is a traditional cultural practice that has been around for centuries and is deeply ingrained in Japanese culture. Ikebana is often seen as a form of meditation and is widely practiced in Japan as well as around the world as a way to bring beauty and harmony into the home or workplace.",
  name: "Ikebana",
  image: Ikebanaimg,
};
...
const Place1 = {
  description:
    "Tokyo Tower is a must-see attraction in Tokyo, Japan. With its 333-meter-high observation deck, visitors can enjoy panoramic views of the city, while also exploring the shops, restaurants, and aquarium located within the tower. Its iconic design and central location make it a favorite destination for tourists and locals alike.",
  name: "Tokyo Tower",
  image: Pl1img,
};
const Place2 = {
  description:
    "Senso-ji Temple, located in Asakusa, Tokyo, is the city's oldest Buddhist temple and a major cultural landmark. Visitors can admire the temple's stunning architecture, including the Kaminarimon Gate and five-story pagoda, as well as participate in various traditional activities such as fortune-telling and street food.",
  name: "Senso-ji Temple",
  image: Pl2img,
};
const Place3 = {
  description:
    "Osaka is a lively city in Japan known for its food culture and vibrant nightlife. The city is home to historical landmarks such as Osaka Castle, as well as modern attractions like Universal Studios Japan. With its friendly locals and bustling atmosphere, Osaka is a great destination for those looking for an exciting urban experience.",
  name: "Akihabara",
  image: Pl3img,
};
